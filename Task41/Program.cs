int InputInt(string message)
{
    ...
    if (isCorrect) /// или  if (int.TryParse(Console.ReadLine(), out value))
    {
        return value;
    }
...
PrintArray(array);
System.Console.WriteLine($"Количество положительных чисел в массиве равно {PositiveCount(array)}");